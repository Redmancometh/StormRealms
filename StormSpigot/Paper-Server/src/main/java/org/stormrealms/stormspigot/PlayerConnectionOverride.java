...
public class PlayerConnectionOverride extends PlayerConnection {
	...
	public void a(PacketPlayInBeacon packetPlayInBeacon) {
		if (packetDispatcher == null)
			...
			packetDispatcher.dispatchPacket(packetPlayInBeacon, this, (PacketPlayInBeacon packet) -> super.a(packet));
	}
	...
	public void a(PacketPlayInStruct packetPlayInStruct) {
		if (packetDispatcher == null)
			...
			packetDispatcher.dispatchPacket(packetPlayInStruct, this, (PacketPlayInStruct packet) -> super.a(packet));
	}
	...
	public void a(PacketPlayInTrSel packetPlayInTrSel) {
		if (packetDispatcher == null)
			...
			packetDispatcher.dispatchPacket(packetPlayInTrSel, this, (PacketPlayInTrSel packet) -> super.a(packet));
	}
	...
	public void a(PacketPlayInBEdit packetPlayInBEdit) {
		if (packetDispatcher == null)
			...
			packetDispatcher.dispatchPacket(packetPlayInBEdit, this, (PacketPlayInBEdit packet) -> super.a(packet));
	}
	...
	public void a(PacketPlayInFlying packetPlayInFlying) {
		if (packetDispatcher == null)
			...
			packetDispatcher.dispatchPacket(packetPlayInFlying, this, (PacketPlayInFlying packet) -> super.a(packet));
	}
	...
	public void a(PacketPlayInUseItem packetPlayInUseItem) {
		if (packetDispatcher == null)
			...
			packetDispatcher.dispatchPacket(packetPlayInUseItem, this, (PacketPlayInUseItem packet) -> super.a(packet));
	}
	...
	public void a(PacketPlayInChat packetPlayInChat) {
		if (packetDispatcher == null)
			...
			packetDispatcher.dispatchPacket(packetPlayInChat, this, (PacketPlayInChat packet) -> super.a(packet));
	}
